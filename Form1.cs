...
namespace Exercise
{
    public partial class Form1 : Form
    {
        ...
        private static Beam CreateStezenie16(Point x, Point y, bool strona)
        {
            Beam belka = new Beam();
        ...
        private static Beam CreateStezenie20(Point x, Point y, bool strona)
        {
            Beam belka = new Beam();
        ...
        private static Beam CreateStezenie12(Point x, Point y, bool strona)
        {
            Beam belka = new Beam();
